...
export default function App() {
  ...
  //   .then((res) => res.json())
  //   .then((data) => setMovies(data.Search)); //gives infinite loop of network call
...
function MovieDetails({ selectedId, onCloseMovie, onAddWatched, watched }) {
  ...
  useEffect(
    function () {
      ...
      //clean up function which runs on js closure
      return function () {
          ...
          <section>
            <div className="rating">
              {!isWatched ? (
                ...
                <p>
                  This movie is already rated {watchedUserRating}
                  <span>⭐</span>
                </p>
              )}
            </div>
...
function MovieList({ movies, onClickMovie }) {
  return (
    <ul className="list list-movies">
      {movies?.map((movie) => (
        <Movie movie={movie} onClickMovie={onClickMovie} />
      ))}
    </ul>
  );
}
...
function Movie({ movie, onClickMovie }) {
  return (
    <li key={movie.imdbID} onClick={() => onClickMovie(movie.imdbID)}>
